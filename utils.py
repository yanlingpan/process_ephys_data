...
def write_to_excel(out_fname, storage, protocol_cellids=None, sweep_ids=None):
		# Create an new Excel file and add a worksheet.
		output_path = os.getcwd() + "/processsed/"
		workbook = xlsxwriter.Workbook(output_path + out_fname)
